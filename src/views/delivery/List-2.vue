        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <div class="line-item d-flex">
                ...
                <span>Số dư: {{ scope.row.customer.balance_amount }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              ...
              <div class="line-item d-flex">
                <img src="@/static/icon/delivery/list/no-checked.svg" />
          ...
          >
            <template slot-scope="scope">
              <div class="line-item d-flex">
                ...
                <span>Hình thức: {{ scope.row.info.carrier }}</span>
              </div>
              <div class="line-item d-flex">
      ...
      <div class="frame-dialog-no-close-1988 delivery-list-show-pack">
        ...
        >
          ...
          <div class="body-1988" v-loading="dialogShowPackLoading">
            ...
            <div class="table-element-custom-2022-v-history pb-4">
              <el-table :data="tableDataDetail" style="width: 100%" border>
                <el-table-column
                  label="STT"
                  width="50"
                  align="center"
  ...
  methods: {
    ...
    showPack(item) {
      ...
      axios.get("delivery/" + item.id).then((response) => {
        ...
        switch (response.code) {
          case 200:
            this.tableListDeliveryPack = response.data;
            break;
          default:
            this.$notify.error({
              title: "Error",
