        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div class="line-item">
                <el-input
                  v-model="scope.row.info.delivery.delivery_cost"
                  placeholder="Số tiền"
                  class="frame-input-common-2022"
                  size="mini"
                  clearable
                ...
                <template slot="append">
                  <span class="moneyDelivery">{{ scope.row.info.delivery.delivery_cost | vnd }}</span>
                </template>
                </el-input>
              </div>
              <div class="line-item">
                <el-select
                  v-model="scope.row.info.delivery.is_delivery_cost_paid"
...
export default {
  ...
  methods: {
        ...
        switch (response.code) {
          case 200:
            ...
            this.tableData.map(function (i) {
              i.info.delivery.delivery_cost = parseInt(i.info.delivery.delivery_cost);
              if (i.info.delivery.delivery_cost == 0) {
                i.info.delivery.delivery_cost = "";
              }
              return i;
            });
    ...
    saveAutoAction(index) {
      ...
      let data = {
        delivery_cost: model.info.delivery.delivery_cost,
        is_delivery_cost_paid: model.info.delivery.is_delivery_cost_paid,
    ...
    printDeliveryBill(item) {
      ...
      //   params: { delivery_id: item.id },
      // });
      let routeData = this.$router.resolve({name: 'delivery-bill', params: {delivery_id: item.id}})
