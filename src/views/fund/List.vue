          ...
          <div class="body-1988">
            <div class="form-item">
              ...
              <div class="form-input">
                ...
                >
                  <el-option-group
                    v-for="group in listCategory.arrFundAllGroup"
                    :key="group.label"
                    :label="group.label">
                    <el-option
            ...
            <div class="form-item">
              ...
              <div class="form-input">
                ...
                >
                  <template slot="append">{{ modelAdd.money }}</template>
                </number>
                <span class="unit-currency">{{ unit_currency }}</span>
              </div>
            </div>
            ...
            <div class="form-item">
              ...
              <div class="form-input">
                <number
                  v-bind="number"
                  placeholder="¥"
                  v-model.lazy="modelChange.cn_change"
                  class="frame-input-common-2022 custom-inpupt-formart-2023"
                >
                </number>
              </div>
                ...
                <div class="form-item">
                  ...
                  <div class="form-input">
                    <number
                      v-bind="number"
                      placeholder=""
                      v-model.lazy="modelChange.fee_customer_total_money"
                      class="frame-input-common-2022 custom-inpupt-formart-2023 disable"
                      disabled
                    >
                    </number>
                  </div>
                ...
                <div class="form-item">
                  ...
                  <div class="form-input">
                    <number
                      v-bind="number"
                      placeholder=""
                      v-model.lazy="modelChange.fee_system_total_money"
                      class="frame-input-common-2022 custom-inpupt-formart-2023 disable"
                      disabled
                    >
                    </number>
...
export default {
  ...
  methods: {
    ...
    caculator() {
      ...
      if (this.modelChange.cn_change) {
        temp_cn_change = Number.parseFloat(this.modelChange.cn_change);
      }
      if (this.modelChange.fee_customer) {
      ...
      this.modelChange.fee_customer_total_money = (temp_cn_change + temp_fee_customer) * this.modelChange.fee_customer_ratio;
      this.modelChange.fee_system_total_money = (temp_cn_change +temp_fee_system) * this.modelChange.fee_system_ratio;
    },
  },
  watch: {
    ...
    "modelAdd.fund_id_from": function () {
      this.listCategory.arrFundUnit.forEach((item) => {
        if (item.value == this.modelAdd.fund_id_from) {
          console.log(item);
          if (item.unit_currency == 1) {
            this.unit_currency = 'đ';
          }
