<template>
  <div class="fund-recharge" id="ST2022">
    <div class="frame-content-common-2022">
        ...
        <div class="item">
          ...
          <div class="input">
            <number
              v-bind="number"
              placeholder="¥"
              v-model.lazy="modelAdd.cn_change"
        ...
        <div class="item">
          ...
          <div class="input">
            <number
              v-bind="number"
              placeholder="Nhập"
              v-model.lazy="modelAdd.fee_change_vnd"
              class="frame-input-common-2022 custom-inpupt-formart-2023"
            >
            </number>
          </div>
        ...
        <div class="item">
          ...
          <div class="input">
            <number
              v-bind="number"
              placeholder="Số tiền"
              v-model.lazy="modelAdd.total_money"
              class="frame-input-common-2022 custom-inpupt-formart-2023"
              disabled
            >
            </number>
          ...
          <table class="table table-hover table-striped">
            ...
            <tbody>
              <tr v-for="i in listCategory.arrFundVN" :key="i.name">
                ...
                <td>
                  <div class="money-fund d-flex align-items-center">
                    <number
                      v-bind="number"
                      placeholder="Nhập"
                      v-model.lazy="i.money"
                      class="frame-input-common-2022 custom-inpupt-formart-2023"
                    >
                    </number>
                    <img src="@/static/icon/fund/detail-ncc/icon3.svg" v-if="i.checked" @click="addBalance(i)" />
                    <img src="@/static/icon/delivery/list/no-checked.svg" v-else @click="addBalance(i)" />
      ...
      <div class="d-flex pt-4 submit-form-recharge">
        <span
...
export default {
  ...
  data () {
    return {
      ...
      // Check số lượng quỹ dc nhập tiền
      countFundInput: 0,
    }
  },
  mounted() {
  ...
  methods: {
    ...
    addBalance(i) {
      if (this.modelAdd.total_money) {
        this.listCategory.arrFundVN.forEach((item) => {
          item.checked = false;
          item.money = "";
        })
        i.money = this.modelAdd.total_money;
        i.checked = true;
      }
    },
    removeBalance(i) {
...
.fund-recharge-wrap-2 .money-fund img {
  margin-left: 10px;
  cursor: pointer;
  margin-right: 5px;
}
...
.submit-form-recharge {
  margin-left: 159px;
}
.submit-form-recharge .btn-crud-2022 {
  padding: 11px 53px;
  font-size: 15px;
}
</style>
