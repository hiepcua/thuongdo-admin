    ...
    <div class="frame-content-common-2022">
      ...
      <div class="d-flex flex-wrap frame-line-filter-2022">
        ...
        <div class="frame-item-filter-2022 filter-via">
          ...
          >
            <el-option
              v-for="item in listCategory.sorts"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022 filter-via">
          ...
          >
            <el-option
              v-for="item in filter.arr_sort_value"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
            ...
            >
              <template slot-scope="scope">
                <div
                  ...
                  @error="handleError"
                >
                  <span class="item-code">{{ scope.row.info.code }}</span>
...
export default {
  ...
  methods: {
    ...
    nextRouteFine(item) {
      this.$router.push({
        name: "fines-create",
        query: { order_code: item.info.code },
      });
    },
