<template>
  <div class="home-index frame-content-common-2022 order-report" id="ST2022">
    ...
    <div v-loading="loading" class="report-info">
      <div class="content-report-frame-2023" v-if="listData.arr_order">
        <div class="content-box-report">
          <span class="numberReport color3">22.341.234.112</span>
          <span class="reportInfo">Tổng khách hàng chăm sóc</span>
        </div>
        <div class="content-box-report">
          <span class="numberReport color4">{{ listData.arr_order.total_not_done | vnd2 }}</span>
        ...
        <div class="content-box-report">
          <span class="numberReport color5">{{ listData.arr_order.total_ordered | vnd2 }}</span>
    ...
    <div class="d-flex" v-loading="loading">
      <div class="width50">
        <div class="d-flex align-item-center" v-if="listData.arr_customer">
          <div class="report-counsel d-flex align-items-center">
            <div class="info-rp d-flex flex-column justify-content-between">
              <span class="number color3">56.392.068.460</span>
              <span class="title">Tổng khách hàng tư vấn chuyển sang</span>
            </div>
            <div class="box-icon">
          ...
          <div class="report-counsel d-flex align-items-center justify-content-between">
            <div class="info-rp d-flex flex-column">
              <span class="number color1">{{ listData.arr_customer.total_order | vnd2 }}</span>
        ...
        <div class="chart-customer-column">
          ...
          <highcharts class="chart" :options="chartCareLine"></highcharts>
        </div>
        <!--  -->
      </div>
      <div class="width50" v-if="listData.arr_customer">
        <div class="d-flex align-item-center">
          <div class="report-counsel d-flex align-items-center justify-content-between">
            <div class="info-rp d-flex flex-column">
              <span class="number color5">{{ listData.arr_customer.total_consignment | vnd2 }}</span>
              <span class="title">Tổng khách hàng ký gửi</span>
            </div>
            <div class="box-icon">
        ...
        <div class="d-flex align-item-center">
          <div class="report-counsel d-flex align-items-center justify-content-between">
            <div class="info-rp d-flex flex-column">
              <span class="number color2">{{ listData.arr_pack.total_pack_not_take | vnd2 }}</span>
          ...
          <div class="report-counsel d-flex align-items-center justify-content-between">
            <div class="info-rp d-flex flex-column">
              <span class="number">{{ listData.arr_complain.total_done | vnd2 }}</span>
      ...
      axios.get("statistic/fast", { params: filter }).then((response) => {
        ...
        switch (response.code) {
          case 200:
            ...
            console.log("ListCou", this.listData);
            break;
          case 422:
            this.$notify.error({
              title: "Lỗi",
