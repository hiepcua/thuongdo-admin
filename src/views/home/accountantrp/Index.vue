  ...
  <div class="home-index frame-content-common-2022 order-report" id="ST2022">
    ...
    <div class="content-report-frame-2023 mt-3">
      <div class="content-box-report">
        <span class="numberReport color3">22.341.234.112 đ</span>
      ...
      <div class="content-box-report">
        ...
        <span class="reportInfo">Tổng doanh thu ngân hàng</span>
      </div>
    </div>
    <!--  -->
    <div class="content-report-frame-2023">
      ...
      <div class="content-box-report">
        <span class="numberReport color2">22.341.234.112</span>
        <span class="reportInfo">Tổng tiền thu trong ngày</span>
      </div>
      <div class="content-box-report">
        <span class="numberReport color6">22.341.234.112</span>
        <span class="reportInfo">Tổng tiền chi trong ngày</span>
      </div>
      <div class="content-box-report">
        <span class="numberReport color5">22.341.234.112</span>
    ...
    return {
      ...
      chartWasehouse: {
        ...
        series:[{
          ...
          {
            name: 'Khoản chi',
              data: [13934, 28656, 65165, 31827, 512143, 242383,
                  871533, 165174, 355157, 261454, 954610, 321001]
          },
        ],
      },
    };
