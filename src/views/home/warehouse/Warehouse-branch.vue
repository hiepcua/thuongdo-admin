  ...
  <div class="home-index frame-content-common-2022 order-report" id="ST2022">
    ...
    <div class="content-report-frame-2023 mt-3">
      ...
      <div class="content-box-report">
        ...
        <span class="reportInfo">Tổng kiện hàng đã nhận trong ngày, tuần, tháng</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
    ...
    <!--  -->
    <div class="report-2-warehouse d-flex">
      <div class="percent50">
        <div class="icon">
          <img src="@/static/icon/Dashboard/warehouse/time.svg" />
        </div>
        <div class="info d-flex flex-column">
          <span class="number color2">99.372.058</span>
          <span class="title">Tổng trọng lượng hàng trong kho</span>
        </div>
      </div>
      <div class="percent50">
        <div class="icon">
        ...
        <div class="info d-flex flex-column">
          <span class="number">372.058.790</span>
          <span class="title">Tổng thể tích hàng trong kho</span>
        </div>
      </div>
    </div>
    <!-- Biểu đồ -->
