  ...
  <div class="home-index frame-content-common-2022 order-report warehouseRP" id="ST2022">
    ...
    <div class="content-report-frame-2023 mt-3">
      <div class="content-box-report">
        ...
        <span class="reportInfo">Tổng số kiện hàng về kho TQ trong ngày</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
      </div>
      <div class="content-box-report">
      ...
      <div class="content-box-report">
        <span class="numberReport color5">22.341.234.112</span>
        <span class="reportInfo">Tổng kiện hàng đã chuyển</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
    ...
    <div class="content-report-frame-2023">
      <div class="content-box-report">
        ...
        <span class="reportInfo">Tổng trọng lượng trong kho TQ</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
      ...
      <div class="content-box-report">
        <span class="numberReport">22.341.234.112</span>
        <span class="reportInfo">Tổng thể tích trong kho TQ</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
      ...
      <div class="content-box-report">
        <span class="numberReport color2">22.341.234.112</span>
        <span class="reportInfo">Tổng khói lượng kiện hàng giao</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
      ...
      <div class="content-box-report">
        <span class="numberReport color4">22.341.234.112</span>
        <span class="reportInfo">Tổng thể tích kiện hàng giao</span>
        <div class="detail-report d-flex align-items-center">
          <img src="@/static/icon/Dashboard/ceo/right.svg" />
          <span>Chi tiết</span>
        </div>
    ...
    <div class="d-flex justify-content-center">
      <div class="chart-customer-column">
        <span class="chart-title">Biểu đồ kiện hàng về kho</span>
        <div class="height40">
          <el-select
            v-model="input"
      ...
      <div class="chart-customer-column">
        <span class="chart-title">Biểu đồ kiện hàng giao</span>
        <div class="height40">
          <el-select
            v-model="input"
            placeholder="Theo tháng"
