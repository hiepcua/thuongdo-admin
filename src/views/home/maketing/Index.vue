        ...
        <div class="height40">
          <div class="d-flex align-items-center">
            ...
            <el-select
              ...
              class="select-date frame-select-common-2022 ml-3"
              popper-class="frame-select-popper-common-2022"
            >
              <el-option
                v-for="item in options"
    ...
    return {
      ...
      chartClientNew: {
        ...
        series:[
            {
              name: '',
              data: [43934, 248656, 65165, 81827, 112143, 142383,
      ...
      chartWebsite: {
        ...
        series:[
            ...
            {
              name: 'Tmall',
              data: [13934, 448656, 25165, 11827, 612143, 342383,
                  171533, 665174, 355157, 61454, 254610, 821001],
            },
            {
              name: 'Taobao',
              data: [43934, 548656, 165165, 821827, 412143, 542383,
                  971533, 65174, 855157, 261454, 654610, 321001],
            },
        ],
      },
