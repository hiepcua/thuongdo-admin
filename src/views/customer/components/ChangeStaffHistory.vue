<template>
  <div class="change-staff-history">
    <el-table
      :data="tableData"
      border
      style="width: 100%"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <div class="d-flex flex-column table-text">
            <span>{{ scope.row.from_staff }}</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
...
<script>
export default {
  name: "ChangeStaffHistory",
  data() {
    return {
      tableData: [
        {
          created_at: "08-05-2022 11:19",
          from_staff: "Lưu Ngọc Trang",
          to_staff: "Đoàn Xuân Kiên",
          staff: "Vũ Thị Hoa",
        },
        {
          created_at: "08-05-2022 11:19",
...
.change-staff-history .el-table thead tr th {
  background-color: #207cdc;
  color: #fff;
  font-size: 14px;
}
.change-staff-history .table-text {
  padding-left: 5px;
  font-weight: 400;
  font-size: 14px;
  color: #000728;
