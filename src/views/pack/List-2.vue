<template>
  <div class="pack-list" id="ST2022">
    <div class="frame-content-common-2022">
      ...
      <div class="btn-seach-wrap my-4" @click="fetchPack()">
      ...
      <div class="table-element-custom-2022 order-list-table tablePack">
        ...
        >
            ...
            <template slot-scope="scope">
              ...
              >
                ...
                <!-- <span class="d-flex align-items-center"
                  ...
                  {{ scope.row.order.package_number }} kiện
                  <img src="@/static/icon/pack/list/edit.svg" />
                </span> -->
                <div class="pack-status d-flex align-items-center">
                  <img class="pr-1" src="@/static/icon/pack/box.svg" alt="" />
                  <div>
          ...
          <el-table-column label="Chiết khấu" align="center">
            <template slot-scope="scope">
              <div class="d-flex flex-column">
...
export default {
  ...
  methods: {
    ...
    // thêm ghi chú pack
    // editNotePack(row) {
    //   this.dialogVisibleNotePack = true;
    //   this.fineDetailIdPack = row.info.id;
    // },
    editNotePackV2(row) {
      this.canSubmit = false;
      let data = {
    ...
    handleSelectionChange(value) {
      ...
      console.log("value", this.listPackSelect);
      // ls("authen", this.listPackSelect);
