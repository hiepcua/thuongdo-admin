<template>
  <div class="pack-detail-component-history">
    <div class="frame-content-title-2022">
      ...
      <span>Lịch sử thay đổi trọng lượng kiện hàng</span>
    </div>
    <div class="table-element-custom-2022-v-history">
      <el-table :data="listActivity.weight" style="width: 100%" stripe border>
        <el-table-column
          label="Ngày thay đổi"
          header-align="center"
          align="center"
        ...
        <el-table-column label="m3 / Kg" header-align="left" align="left">
          <template slot-scope="scope">
    ...
    <div class="frame-content-title-2022">
      <img src="@/static/icon/action/to-right.svg" alt="" />
      <span>Lịch sử thay đổi thông tin</span>
    </div>
    <div class="table-element-custom-2022-v-history">
      <el-table :data="listActivity.info" style="width: 100%" stripe border>
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.properties.old }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="Giá trị mới"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.properties.new }}</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
