<template>
  <div class="pack-list" id="ST2022">
    <div class="frame-content-common-2022">
      ...
      <div class="d-flex flex-wrap frame-line-filter-2022" v-if="listCommon.order">
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.order.delivery_types"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.order.ecommerce"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022">
          ...
          >
            <el-option
              v-for="item in listCommon.order.categories"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            >
      ...
      <div class="d-flex flex-wrap">
        <div class="frame-item-filter-2022 filter-staff" v-if="listCommon.staffs">
          <el-select
        ...
        <div class="frame-item-filter-2022 filter-staff" v-if="listCommon.staffs">
          ...
          >
            <el-option
              v-for="item in listCommon.staffs.quote"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            >
        ...
        <div class="frame-item-filter-2022 filter-staff" v-if="listCommon.warehouses">
          <el-select
          ...
          >
            <el-option
              v-for="item in listCommon.warehouses.vi"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            >
        ...
        <div class="frame-item-filter-2022 filter-staff" v-if="listCommon.warehouses">
          ...
          >
            <el-option
              v-for="item in listCommon.warehouses.cn"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            >
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.types"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.modifies"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.status"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
        ...
        <div class="frame-item-filter-2022 filter-level">
          ...
          >
            <el-option
              v-for="item in listCommon.requests"
              :key="item.value"
              :label="item.name"
              :value="item.value"
            >
      ...
      <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <div class="order-list-total-money" v-if="listCommon.reports">
          <span class="title">Tổng tiền vận chuyển cần thanh toán</span>
        ...
        >
          ...
          <el-table-column label="Thao tác" align="center" fixed="right">
            <template slot-scope="scope">
              ...
              <div class="item-action" @click="printDeliveryBill(scope.row)">
                <el-tooltip
                  v-if="scope.row.info.delivery_id !== null"
                  class="item"
                  effect="dark"
              ...
              <div class="item-action" @click="CancelPack(scope.row)">
                <el-tooltip
                  class="item"
                  effect="dark"
                  content="Hủy"
      ...
      <div class="pack-to-VN" v-if="showPackToVN">
        <div class="table-element-custom-2022 order-list-table tablePack" >
          <el-table style="width: 100%" border :data="reportsPackToVN.orders">
            ...
            <el-table-column label="Tạm ứng" width="280">
              <template slot-scope="scope">
                <span>{{ scope.row.deposit_cost }}</span>
              </template>
            </el-table-column>
            <el-table-column label="Còn lại" width="250">
              <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    fetchPack() {
      ...
      axios.get("package", { params: filter }).then((response) => {
        ...
        switch (response.code) {
          case 200:
            this.tableData = response.data.items;
            if(response.data.reports !== undefined) {
    ...
    printDeliveryBill(item) {
      ...
      // });
      let routeData = this.$router.resolve({name: 'delivery-bill', params: {delivery_id: item.info.delivery_id}})
    ...
    CancelPack(row) {
      this.$confirm("Xác nhận hủy đơn", "Cảnh báo", {
        ...
        .then(() => {
          if(row.status.value == 'status_0') {
            this.CancelStatus(row);
          } else {
            this.$notify.error({
              title: "Error",
              message: "Kiện hàng ở trạng thái chờ xử lý mới được hủy !",
            });
          }
        })
        .catch(() => {});
    ...
    handleSelectionChange(value) {
      ...
      this.listPackSelect.forEach((item) => {
        let dataLS = {
          ...
          china_shipping_cost: item.costs.amount,
    ...
    // },
    getPackToVN() {
      if (this.filter.customer_name == "" && this.filter.customer_phone == "") {
        this.$notify({
          title: "Có lỗi xảy ra",
          message: "Bạn chưa nhập khách hàng",
          type: "warning",
        });
      }
      else {
...
.pack-to-VN .table-element-custom-2022 {
  padding-bottom: 0;
}
.color-green {
  color: #da0606;
