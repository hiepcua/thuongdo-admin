        ...
        >
          ...
          <el-table-column label="Chênh lệch" header-align="center">
            <el-table-column label="CNY" header-align="center" width="100">
              <template slot-scope="scope">
                <span>{{ ((scope.row.order_cost + scope.row.china_shipping_cost) - (scope.row.order_cost_old + scope.row.china_shipping_cost_old)) | vnd3 }}</span>
              </template>
            </el-table-column>
            <el-table-column label="VND" header-align="center" width="150">
              <template slot-scope="scope">
                <span>{{ (((scope.row.order_cost + scope.row.china_shipping_cost) - (scope.row.order_cost_old + scope.row.china_shipping_cost_old)) * scope.row.exchange_rate) | vnd }}</span>
              </template>
            </el-table-column>
          </el-table-column>
          <el-table-column
