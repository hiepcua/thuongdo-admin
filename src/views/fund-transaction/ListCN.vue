  ...
  <div class="fund-transaction-list" id="ST2022">
    <div class="frame-content-common-2022">
      <div class="frame-content-title-2022-v2">
        ...
        <span class="title">Lịch sử thu chi tiền Trung Quốc</span>
      </div>
      ...
      <div class="table-element-custom-2022-v2 fund-transaction-list-table mt-3">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <div class="line-item img-text" v-if="scope.row.fund_type_pay_txt">
                <img src="@/static/icon/fund-transaction/list-cn/Done-Purchase.svg"/>
                <span>{{ scope.row.fund_type_pay_txt }}</span>
              </div>
              <div class="line-item img-text">
                <img src="@/static/icon/fund-transaction/list-cn/icon3.svg"/>
          ...
          >
            <template slot-scope="scope">
              <div class="line-item">
                ...
                {{ scope.row.type_pay == 1 ? '+' : '-'}}{{ scope.row.money | vnd3 }}
                </span>
              </div>
            </template>
          </el-table-column>
          ...
          >
            <template slot-scope="scope">
              <div class="item-action" v-if="scope.row.fund_type_pay_code == 0">
            ...
            <div class="form-item">
              ...
              <div class="form-input">
                <el-input
                  ...
                  type="number"
                >
                  <template slot="append">{{ modelAdd.money | vnd3 }}</template>
                </el-input>
              </div>
            </div>
            <div class="form-item">
...
export default {
  name: 'FundTransactionListCN',
  metaInfo() {
    return {
      title: "Lịch sử thu chi tiền Trung Quốc",
    };
  },
  data () {
    return {
